...
// Rectification du nom de la page qui est 'connect.php' alors que c'etait 'connection.php' qui etais present.
require_once 'connect.php';

$order = '';
$errors ='';

if(isset($_GET['order']) && isset($_GET['column'])){ // Rectification manque d'une " ) ".
...
if(!empty($_POST)){
	...
	foreach($_POST as $key => $value){
        $_POST['$key'] = strip_tags(trim($value)); // Rectification une " ) " de trop.
	}
	...
	if(count($errors) <= 1) {
        ...
        $insertUser->bindValue(':firstname', $_POST['firstname']); // Rectification car manque d'un " ; ".
        ...
        <div class="container">
	        ...
	        <div class="row">
                ...
                if(isset($createUser) && $createUser == true){
                    ...
                    echo '</div><br>'; // Rectification car manque d'un " ; ".
                }
